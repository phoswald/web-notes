...
/**
 * Configures Jackson's JSON serializer/deserializer.
 * <p>
 * This is the only class with a dependency on Jackson.
 * Also, JAX-RS does not require any annotations on request/response POJOs.
 * <p>
 * The JSON serializer/deserializer will access the request/response POJO's properties using getters and setters,
 * not fields. This also means that such properties can use different Java types for JPA and JAX-RS if
 * the @Id and @Column annotations are placed on fields.
 */
@Provider
